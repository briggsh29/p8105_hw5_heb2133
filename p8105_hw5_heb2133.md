...
experimental arms - the control arm appears to diverge from the
experiemental arm in terms of observations.

## Problem 3

Generate 5000 datasets from normal distrib with n = 50, sigma = 5, and
mu = 0.
